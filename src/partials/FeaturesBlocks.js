        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl h-72">
              <img class="w-40 h-40 md:rou rounded-full mx-auto" src={require('../imagesSvg/payment.svg').default} alt="" width="384" height="512">
              </img>
            ...
            {/* 2nd item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl h-72">
              <img class="w-40 h-40 md:rou rounded-full mx-auto" src={require('../imagesSvg/remote.svg').default} alt="" width="384" height="512">
              </img>
            ...
            {/* 3rd item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl h-72 ">
              <img class="w-40 h-40 md:rou rounded-full mx-auto" src={require('../imagesSvg/learning.svg').default} alt="" width="384" height="512">
              </img>
            ...
            {/* 4th item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl h-72">
              <img class="w-40 h-40 md:rou rounded-full mx-auto" src={require('../imagesSvg/medical.svg').default} alt="" width="384" height="512">
              </img>         
            ...
            {/* 5th item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl h-72">
              <img class="w-40 h-40 md:rou rounded-full mx-auto" src={require('../imagesSvg/meditation.svg').default} alt="" width="500" height="512">
              </img>
            ...
            {/* 6th item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl h-72">
              <img class="w-40 h-40 md:rou rounded-full mx-auto" src={require('../imagesSvg/travel.svg').default} alt="" width="384" height="512">
              </img> 
