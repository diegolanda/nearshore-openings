    ...
    <section className="relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-12 md:pt-20 md:pb-20">
          ...
          {/* Section header */}
          <div className="text-center pb-10 md:pb-6">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-0" data-aos="zoom-y-out">{t('home.title')}<br/><span className="bg-clip-text text-transparent bg-gradient-to-r from-green-800 to-teal-400">{t('home.short_description')}</span></h1>
